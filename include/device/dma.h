...
// #define GPIO_BASE_BUS 0x7E200000 //this is the physical bus address of the GPIO module. This is only used when other
// peripherals directly connected to the bus (like DMA) need to read/write the GPIOs #define PWM_BASE_BUS 0x7E20C000
